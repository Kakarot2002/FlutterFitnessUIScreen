...
class Rail2CardComponent extends StatefulWidget {
  // ignore: prefer_const_constructors_in_immutables
  Rail2CardComponent({Key? key, required this.linkimg, required this.mainText})
      : super(key: key);
  final String linkimg;
  final String mainText;
  @override
  // ignore: library_private_types_in_public_api
  _MyRail2CardComponent createState() => _MyRail2CardComponent();
}

class _MyRail2CardComponent extends State<Rail2CardComponent> {
  @override
