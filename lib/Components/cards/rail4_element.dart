...
class Rail4CardComponent extends StatefulWidget {
  // ignore: prefer_const_constructors_in_immutables
  Rail4CardComponent({Key? key, required this.linkimg, required this.mainText})
      : super(key: key);
  final String linkimg;
  final String mainText;
  @override
  // ignore: library_private_types_in_public_api
  _MyRail4CardComponent createState() => _MyRail4CardComponent();
}

class _MyRail4CardComponent extends State<Rail4CardComponent> {
  @override
